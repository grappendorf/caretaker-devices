...
public class SwitchWidgetConfigurer extends Activity
{
	@Override
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		setContentView(R.layout.switch_widget_configurer);
		...
		((EditText) findViewById(R.id.switchNumber)).setText(prefs.getString(PREFS_SWITCH_NUMBER + appWidgetId, "0"));
		((EditText) findViewById(R.id.label)).setText(prefs.getString(PREFS_LABEL + appWidgetId, getResources()
						.getString(R.string.switch_label)));
		...
		findViewById(R.id.buttonSave).setOnClickListener(new OnClickListener()
		{
			...
			public void onClick(View v)
			{
				...
				prefs.putString(PREFS_DEVICE_ADDRESS + appWidgetId, ((EditText) findViewById(R.id.deviceAddress))
								.getText().toString());
				prefs.putString(PREFS_SWITCH_NUMBER + appWidgetId, ((EditText) findViewById(R.id.switchNumber))
								.getText().toString());
				...
				AppWidgetManager appWidgetManager = AppWidgetManager.getInstance(SwitchWidgetConfigurer.this);
				SwitchWidgetProvider.updateAppWidget(SwitchWidgetConfigurer.this, appWidgetManager, appWidgetId);
	...
	private static final String TAG = "SwitchWidgetConfigurer";
	...
	public static final String PREFS_SWITCH_NUMBER = "switchNumber_";
